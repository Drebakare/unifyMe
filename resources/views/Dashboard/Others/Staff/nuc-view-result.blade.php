                            ...
                            <div class="inner-item">
                                <table id="attendenceDetailedTable" class="display responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th><i class="fa fa-book"></i>University</th>
                                    ...
                                    @foreach($students as $key => $student)
                                        <tr>
                                            ...
                                            <td class="action-link">
                                                <a class="edit" href="{{route('user.nuc-view-student-result', ['id' => $student->id])}}" ><i class="fa fa-check-circle"></i> <big style="color: #27AE60">Check Result</big></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
