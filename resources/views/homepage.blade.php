    ...
    <div class="row">
        <div id="homeSlider" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item">
                    <img src="{{asset('_landing/assets/img/slider/slide5.jpg')}}" alt="slide2">
                    <div class="carousel-caption">
                        <h4><i class="fa fa-star-o"></i>WE ARE BEST<i class="fa fa-star-o"></i></h4>
                        <h2>A Secured Platform for <span>Education</span> Record Verification</h2>
                        <a href="{{route('request_form')}}"><i class="fa fa-paper-plane"></i>Request Access</a>
                    </div>
                </div>
                {{--<div class="item">
                    <img src="{{asset('_landing/assets/img/slider/slide6.jpg')}}" alt="slide2">
                    <div class="carousel-caption">
                        <h4><i class="fa fa-star-o"></i>WE ARE BEST<i class="fa fa-star-o"></i></h4>
        ...
        <div class="container">
            ...
            <div class="fact-wrapper">
                <div class="col-md-5 fact-item">
                    ...
                    <p>Unify System</p>
                    <p>Maintains and manages competency standards and continuous professional development</p>
                </div>
                <div class="col-md-7 fact-item">
                    <div class="fact-item-list">
                        ...
                        <div class="col-xs-9">
                            <h2><br />SECURITY</h2>
                            <p>Creativity and flexibility that reduces manipulation of continuous assessment results, examination records and eliminates falsification of report sheets because Unify System acts as
                                a depository that preserves test scores, examination records, report sheets and certificates</p>
                        </div>
                    ...
                    <div class="fact-item-list">
                        ...
                        <div class="col-xs-9">
                            <h2><br />Effective Tool</h2>
                            <p>A reliable check tool capable of protecting employers against negligent hiring claims</p>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="1">
                    <div class="col-md-8 left-event-items">
                        <div class="event-item">
                            ...
                            <div class="col-sm-5 event-item-img">
                                <div class="event-img">
                                    <img src="{{asset('_landing/assets/img/news/news-sm1.jpg')}}" alt="event" />
                        ...
                        <div class="event-item">
                            ...
                            <div class="col-sm-5 event-item-img">
                                <div class="event-img">
                                    <img src="{{asset('_landing/assets/img/news/news-sm2.jpg')}}" alt="event" />
                                    <div class="event-detail-link">
                                        <a href="#">VIEW DETAILS</a>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-4 right-event-items">
                        <div class="event-item">
                            <img src="{{asset('_landing/assets/img/news/news-lg3.jpg')}}" alt="event" />
                        </div>
